...
public class Libretto {
	 ...
	 * @return {@code true} nel caso normale, {@code false} se
	 * 			non è riucito ad aggiungere il voto
	 */
...
//		}
	...
	/**
	 * Mi dice se il {@link Voto} {@code v} è in concflitto on uno dei voti
	 * esistenti. Se il voto non esiste, non c'è conflitto. Se esiste ed ha 
	 * punteggio diverso, c'è conflitto
	 * 
	 * @param v
	 * @return {@code true} se il voto esiste e ha un punteggio diverso, 
